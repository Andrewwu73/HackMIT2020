  ...
  return (
    ...
    >
      <Container maxWidth="lg">
        ...
        <Typography variant="body1" gutterBottom>
          To analyze the datasets, we took a variety of approaches. On the home page, you can see a forecast of the GDPs
          ...
          average work hours, education index and youth mortality rate. From this input, the model uses a recursive neural network
          to predict the values of these indicators in the following year. This model was trained using data on these indicators from the
          University of Groningen and Our World in Data. Using this model, we can make predictions
